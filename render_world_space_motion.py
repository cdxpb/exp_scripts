...
if __name__ == "__main__":
    ...
    smooth_fit_coco_file = "./visjson/"+subset+"/"+filename+".json"
    # The original video corresponding to the json file
    video_path = "./copied/"+subset+"/"+filename+".mp4"
    ...
    output_path = "./motionxvis/"+subset+"/"+filename+"_mxglobal.mp4"
